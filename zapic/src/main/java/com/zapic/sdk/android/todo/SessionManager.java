...
//
//    /**
//     * The request identifier for JavaScript callbacks.
//     */
//    @NonNull
...
//
//    /**
//     * Dispatches a "QUERY" message to the Zapic web page.
//     *
//     * @param dataType        The requested data type.
//     * @param dataTypeVersion The requested schema version of the data type.
//     */
//    @MainThread
//    private void dispatchQuery(@NonNull final String dataType, @NonNull final String dataTypeVersion) {
//        if (mWebView != null) {
//            try {
//                dispatch(new JSONObject()
//                        .put("type", "QUERY")
//                        .put("payload", new JSONObject()
//                                .put("requestId", mRequestId.incrementAndGet())
//                                .put("dataType", dataType)
//                                .put("dataTypeVersion", dataTypeVersion)));
